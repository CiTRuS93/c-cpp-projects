...
#define PGSHIFT         12      // log2(PGSIZE) = 12
...
#define PTE_PG 0x200
#define PTE_C           0x400   // Cow - if its on --> change while page fault to writeable

// turn on relevant page flags
#define PTE_PG_ON(pte)      ((uint)(pte) | PTE_PG)
#define PTE_A_ON(pte)       ((uint)(pte) | PTE_A)
#define PTE_P_ON(pte)       ((uint)(pte) | PTE_P)
// turn off/on the relevant page flags, depands its previous flag
