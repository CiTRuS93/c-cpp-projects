...
int main(int argc, char **argv){
    ...
    struct fun_desc menu[] = { { "Toggle Debug Mode",toggle_debug_mode}, { "Examine ELF File",exemainElf},{"Print Section Names",SecName},{"Print Symbols",printSym},{ "Quit", quit}, {NULL,NULL} };
